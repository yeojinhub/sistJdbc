package day0324.kr.co.sist.pstmt.design;
...
import day0324.kr.co.sist.pstmt.evt.PreparedWindowEvent;
...
public class PreparedWindow extends JFrame {
	...
	public PreparedWindow() {
		...
		PreparedWindowEvent pwe = new PreparedWindowEvent(this);
		jbtnAdd.addActionListener(pwe);
		jbtnChange.addActionListener(pwe);
		jbtnDelete.addActionListener(pwe);
		jbtnClose.addActionListener(pwe);
		jlData.addMouseListener(pwe);
